...
export default function QuestionsPage() {
  ...
  const loadQuestions = async () => {
    try {
      ...
      // Load questions from localStorage (in real app, this would be from API)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Berhasil",
        description: editingQuestion ? "Soal berhasil diperbarui" : "Soal berhasil ditambahkan"
      });
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <h1 className="text-2xl font-bold mb-2">Bank Soal</h1>
            <p className="text-gray-600">
              Kelola bank soal dan pertanyaan untuk ujian
            </p>
          </div>
          ...
          {showAddForm && (
            <Card className="mb-6">
              <CardHeader>
                ...
                <CardDescription>
                  {editingQuestion ? 'Perbarui data soal' : 'Masukkan data soal baru'}
                </CardDescription>
              </CardHeader>
              <CardContent>
